...
const Home = () => {
  ...
  useEffect(() => {
    let url = `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=7f604cf66d68b73133d1652eb9d5cd2b`;

    if (search) {
      url = `https://api.themoviedb.org/3/search/movie?query=${search}&api_key=7f604cf66d68b73133d1652eb9d5cd2b`;
    }
